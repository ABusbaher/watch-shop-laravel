                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                            ...
                            <div class="form-group{{ $errors->has('phone') ? 'errors' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="phone" type="text" class="form-control" name="phone" value="{{ old
                                    ('phone') }}">
                            ...
                            <div class="form-group{{ $errors->has('state') ? ' has-error' : '' }}">
                                <label for="state" class="col-md-4 control-label">Country</label>

                                <div class="col-md-6">
                                    <input id="state" type="text" class="form-control" name="state" value="{{ old
                                    ('state') }}">
                            ...
                            <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="city" type="text" class="form-control" name="city" value="{{ old
                                    ('state') }}">
                            ...
                            <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="address" type="text" class="form-control" name="address" value="{{ old
                                    ('address') }}">
                            ...
                            <div class="form-group{{ $errors->has('postal_code') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="postal_code" type="text" class="form-control" name="postal_code" value="{{ old
                                    ('postal_code') }}">
